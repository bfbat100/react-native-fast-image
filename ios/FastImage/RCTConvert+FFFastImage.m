...
+ (FFFastImageSource *)FFFastImageSource:(id)json {
    ...
    NSString *placeholderImage = json[@"placeholderImage"];
    FFFastImageSource *imageSource = [[FFFastImageSource alloc] initWithURL:uri priority:priority headers:headers cacheControl:cacheControl placeholderImage:placeholderImage];
